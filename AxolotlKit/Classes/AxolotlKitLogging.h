...
//
    ...
    #define AXO_LOG_LEVEL_DEF DDLogFlagInfo
...
#define DDLogFlagVerbose 4
    ...
    #define AXOLogDebug(frmt, ...) LOG_MAYBE(LOG_ASYNC_ENABLED,     AXO_LOG_LEVEL_DEF, DDLogFlagDebug,      0, nil, __PRETTY_FUNCTION__, frmt, ##__VA_ARGS__)
